...
//   let newTickes
//   if(profile !== 'admin'){
//     newTickes = orderBy(tickets, (obj) => parseISO(obj.lastMessageAt || obj.updatedAt), ['asc']).filter(ticket => ticket.userId === parseInt(userId) ||  ticket.userId === null)
//   } else if (profile === 'admin'){
//     newTickes = orderBy(tickets, (obj) => parseISO(obj.lastMessageAt || obj.updatedAt), ['asc'])
//   }
//   // return [...newTickes]
// }
...
const atendimentoTicket = {
  ...
  mutations: {
    ...
    LOAD_TICKETS(state, payload) {
      // const userId = localStorage.getItem('userId')
      // console.log(state.tickets.filter(ticket => ticket.userId === parseInt(userId)))
      ...
      newTickets.forEach((ticket) => {
        ...
        if (ticketIndex !== -1) {
          ...
          if (checkTicketFilter(ticket)) {
            // if(ticket.userId !== parseInt(userId)) return
