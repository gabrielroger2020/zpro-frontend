<template>
  <q-page class="q-pa-md">
    <div class="q-gutter-md row justify-around">
      ...
      <q-card flat bordered class="my-card col-12">
        ...
        <q-card-actions align="right">
          <q-btn color="primary" @click="applyColors">Aplicar Cores</q-btn>
          <q-btn color="negative" @click="saveColorsToBackend">Salvar Cores</q-btn>
        </q-card-actions>
      </q-card>
    ...
    <div class="text-center q-mt-md">
      <q-btn color="negative" @click="buildFrontend">Build Frontend</q-btn>
    </div>
  </q-page>
</template>

<script>
import { UploadLogo, UploadIcon, Build } from 'src/service/customizar';
